...
function WebTrends(){
	...
	this.dcsid="dcsg3teij000008adj6gryzsf_4b6y";
	this.domain="statse.webtrendslive.com";
	this.timezone=1;
	this.fpcdom=".sf.tv";
	this.onsitedoms=(function(){return(window.RegExp?new RegExp("\.sf\.tv","i"):"");})();
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,mp3,gg,gadget,exe,dmg,gar";
...
// SF.tv - Custom Function
WebTrends.prototype.dcsQP =function(){
  var qry=location.search.substring(1);
  if (qry!=""){
    if (qry.indexOf('DCSext.')!=-1 || qry.indexOf('WT.')!=-1 ){
      ...
      for (var i=0;i<pairs.length;i++){
        ...
        if (pos!=-1){
          ...
          if(param.indexOf('DCSext.')==0){
            this.DCSext[param.substring(7)] = pairs[i].substring(pos+1);
          }else if(param.indexOf('WT.')==0){      	
            this.WT[param.substring(3)] = pairs[i].substring(pos+1); 
          }
        }
      }
    }
...
document.write("<scr"+"ipt type='text/javascript' src='http://www.sf.tv/js/WT_migrationcode_new.js'><\/scr"+"ipt>");